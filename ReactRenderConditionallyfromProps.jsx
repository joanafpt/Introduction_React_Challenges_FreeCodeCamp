...
class Results extends React.Component {
    ...
    render() {
      return (
        <h1>
          { /* render the fiftyFifty props in the Results component.*/
  ...
  class GameOfChance extends React.Component {
    ...
    handleClick() { /*Change handleClick() to increment. */
      this.setState({
    ...
    render() {
      ...
      return (
        <div>
        {/*write a ternary expression to pass props in the Results component. */}
