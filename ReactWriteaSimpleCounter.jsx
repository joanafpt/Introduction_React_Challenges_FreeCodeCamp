...
class Counter extends React.Component {
    constructor(props) {
      ...
      /*remember to add the necessary bindings for the newly-created methods in the constructor */
    ...
    /*There are two buttons which call methods increment() and decrement(). Write these methods so the counter value is incremented or decremented by 1 when the appropriate button is clicked.*/
    increment() {
      this.setState({
